...
import { Coffee, MapPin, Phone, Mail, Clock, User, CreditCard } from "lucide-react"
...
export const CustomerReceipt = React.forwardRef<HTMLDivElement, CustomerReceiptProps>(
      ...
      <div ref={ref as React.RefObject<HTMLDivElement>} className="bg-white text-black p-6 w-[400px] mx-auto font-mono text-sm shadow-lg rounded-lg border">
        ...
        <div className="text-center mb-6">
          ...
          <div className="bg-amber-50 px-3 py-1 rounded-full inline-block">
            <span className="text-xs text-amber-800 font-medium">Customer Receipt</span>
          </div>
        </div>
        ...
        {/* Footer */}
        <div className="bg-gradient-to-br from-amber-600 to-orange-600 text-white rounded-lg p-6 text-center shadow-lg">
          <div className="mb-4">
            <div className="w-12 h-12 bg-white/20 rounded-full flex items-center justify-center mx-auto mb-3">
              <Coffee className="w-6 h-6" />
            </div>
            <p className="text-lg font-bold mb-2">Thank you for visiting!</p>
            <p className="text-sm text-amber-100 mb-1">We appreciate your business</p>
            <p className="text-sm text-amber-100">Follow us: @DaCoffee | www.dacoffee.com</p>
          </div>

          <div className="border-t border-white/20 pt-3 space-y-2">
            <div className="bg-white/10 rounded-lg px-3 py-2 backdrop-blur-sm">
              <p className="text-sm font-medium">Customer Copy - Please keep your receipt</p>
              <p className="text-xs text-amber-200 mt-1">Receipt #{orderId}</p>
            </div>
            <div className="text-xs text-amber-200/80">
              <p>Generated on {dateStr} at {timeStr}</p>
              <p className="mt-1">🌟 Rate us on our website! 🌟</p>
            </div>
          </div>
        </div>
